...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    ...
    <link rel="stylesheet" type="text/css" href="<%=common_path.url %>table_css/css/util.css">
	<link rel="stylesheet" type="text/css" href="<%=common_path.url %>table_css/css/main.css">
...
<%--                              <strong>Welcome <%=obj_Login_Bean.getUser_name() %>!</strong> --%>
			...
			<div style = "text-align:center">
				...
				<h1>Crear Pedido</h1><br><br>
				
				<form action="controller/insert_controller.jsp">
					
					ID pedido : <input type="text" name="idPedido"><br><br>
<!-- 					ID de usuario : <input type="text" name="idUser"><br><br> -->
